...
function openZoneModal(zone) {
    ...
    var groupsHeader = 'Groups (' + groups.length + '/' + groupsMax + ')';
    var groupsHtml = '';

    if (groups.length > 0) {
        groupsHtml =
            '<div style="margin-top: 14px;">' +
                '<div style="padding-bottom: 6px; color: #8892a0;">' + groupsHeader + '</div>' +
...
=======
    ...
    body.innerHTML = html;
>>>>>>> 30b585546ff6bd18e859386b4ef82393cebe4273:src/foothold_sitac/static/js/map.js
